...
public class SprocketActivity extends Activity {
    ...
    private static final String TAG = "SprocketActivity";

    private static final String ACTIVE_SPROCKET_URL_KEY = "activeUrl";
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sprocket_activity);
        mSprocketManager = (SprocketManager) findViewById(R.id.sprocket_container);
        final boolean listenToActivityState = true;
        mWindowAndroid = new ActivityWindowAndroid(this, listenToActivityState);
        mWindowAndroid.restoreInstanceState(savedInstanceState);
        mSprocketManager.setWindow(mWindowAndroid);
        // Set up the animation placeholder to be the SurfaceView. This disables the
        // SurfaceView's 'hole' clipping during animations that are notified to the window.
        mWindowAndroid.setAnimationPlaceholderView(
                mSprocketManager.getContentViewRenderView().getSurfaceView());
    ...
    private void finishInitialization(Bundle savedInstanceState) {
        String sprocketUrl = SprocketManager.DEFAULT_SPROCKET_URL;
    ...
    private void initializationFailed() {
        ...
        Toast.makeText(SprocketActivity.this,
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        if (contentViewCore != null) {
            outState.putString(ACTIVE_SPROCKET_URL_KEY, contentViewCore.getWebContents().getUrl());
        }
    ...
    /**
     * @return The {@link SprocketManager} configured for the activity or null if it has not been
     *         created yet.
     */
    public SprocketManager getSprocketManager() {
        return mSprocketManager;
    }
